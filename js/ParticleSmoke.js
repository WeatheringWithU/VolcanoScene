...
void main(){
	...
	gl_PointSize = customSize * 5.0;
	gl_Position = projectionMatrix * mvPosition;
}
`;

const particleFragmentShader2 = `
...
Particle2.prototype.update = function(dt)
{
	...
	this.particleMaterial = new THREE.ShaderMaterial( 
		{
			...
			vertexShader:   particleVertexShader2,
			fragmentShader: particleFragmentShader2,
			transparent: true,
...
ParticleSmoke.prototype.setValues = function( parameters )
{
	...
	Particle2.prototype.sizeChange    = this.sizeChange;
	Particle2.prototype.colorChange   = this.colorChange;
	Particle2.prototype.opacityChange = this.opacityChange;
...
ParticleSmoke.prototype.randomValue = function(base, spread)
{
...
ParticleSmoke.prototype.createParticle = function()
{
...
ParticleSmoke.prototype.initialize = function()
{
...
ParticleSmoke.prototype.update = function(dt)
{
	var recycleIndices = [];
	const positionArray = new Float32Array(this.particleCount * 3);
	const VisibleArray = new Float32Array(this.particleCount * 1);
...
ParticleSmoke.prototype.destroy = function()
{
